...
<img align="left" style="margin-right:10px;" src="https://github.com/mai00fti/EcoToxFred/blob/main/figures/assistant.png"> EcoToxFred can answer questions about chemicals and their measured concentrations in European surface waters like rivers and lakes.
